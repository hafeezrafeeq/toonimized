        ...
        <>
            <div className="bg-stone-800">
                <div className=" flex justify-betWeen items-center">
                    <div className="w-1/2">
                        <div><img className="absolute inset-0 top-290 z-10 w-100 m-20" src="https://res.cloudinary.com/dapozvnbr/image/upload/v1600087154/Home/Ellipse_7_uxz08y.png" alt="img" /> </div>
                        <div className="absolute inset-0 top-270 z-0 + left-10 custpmizeCircle w-120 h-120 rounded-full "></div>

                    </div>


                    <div className="raleway text-stone-50 font-bold text-8xl mt-35  p-25 text-end" >
                        <h1>Let’s transform <br />
                            you into art</h1>

                        <div className="text-stone-50 raleway text-3xl font-bold mt-8">
                            <p>Get yourself a hand-drawn character! </p></div>

                        <div className="text-stone-50 raleway text-2xl font-bold w-180 mt-6">
